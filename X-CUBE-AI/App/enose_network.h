/**
  ...
  ******************************************************************************
  */
#ifndef AI_ENOSE_NETWORK_H
#define AI_ENOSE_NETWORK_H

#include "enose_network_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ENOSE_NETWORK_MODEL_NAME          "enose_network"
#define AI_ENOSE_NETWORK_ORIGIN_MODEL_NAME   "enose_integration_smoke_float32"

/******************************************************************************/
#define AI_ENOSE_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ENOSE_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ENOSE_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ENOSE_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_ENOSE_NETWORK_IN \
  ai_enose_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ENOSE_NETWORK_IN_SIZE { \
  AI_ENOSE_NETWORK_IN_1_SIZE, \
}
#define AI_ENOSE_NETWORK_IN_SIZE_BYTES { \
  AI_ENOSE_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_ENOSE_NETWORK_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ENOSE_NETWORK_IN_1_HEIGHT      (60)
#define AI_ENOSE_NETWORK_IN_1_CHANNEL     (5)
#define AI_ENOSE_NETWORK_IN_1_SIZE        (300)
#define AI_ENOSE_NETWORK_IN_1_SIZE_BYTES  (1200)

/******************************************************************************/
#define AI_ENOSE_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ENOSE_NETWORK_OUT \
  ai_enose_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ENOSE_NETWORK_OUT_SIZE { \
  AI_ENOSE_NETWORK_OUT_1_SIZE, \
}
#define AI_ENOSE_NETWORK_OUT_SIZE_BYTES { \
  AI_ENOSE_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_ENOSE_NETWORK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ENOSE_NETWORK_OUT_1_CHANNEL     (16)
#define AI_ENOSE_NETWORK_OUT_1_SIZE        (16)
#define AI_ENOSE_NETWORK_OUT_1_SIZE_BYTES  (64)

/******************************************************************************/
#define AI_ENOSE_NETWORK_N_NODES (7)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup enose_network
 ...
 * @ref ai_enose_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_enose_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_enose_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_enose_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ENOSE_NETWORK_*
 * defines into file @ref enose_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_enose_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_ENOSE_NETWORK_H */
